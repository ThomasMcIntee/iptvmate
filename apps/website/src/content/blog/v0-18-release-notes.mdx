...
- **GitHub Sponsors**: [https://github.com/sponsors/thomasmcintee](https://github.com/sponsors/thomasmcintee)
- **Buy me a coffee**: [https://ko-fi.com/thomasmcintee](https://ko-fi.com/thomasmcintee)
...
<LinkCards
  links={[
    ...
    {
      label: 'Ko-fi',
      href: 'https://ko-fi.com/thomasmcintee',
  ...
  links={[
    {
      ...
      href: 'https://github.com/thomasmcintee/iptvmate/releases/tag/v0.18.0',
